...
async function add(req: Request, res: Response) {
  try {
    ...
    res
      .status(201)
      .json({ message: "Circuito created successfully", data: addImageUrls(req, circuito) });
  } catch (error: any) {
...
async function update(req: Request, res: Response) {
  try {
    ...
    res
      .status(200)
      .json({ message: "Circuito updated successfully", data: addImageUrls(req, circuito) });
  } catch (error: any) {
    if (error instanceof NotFoundError) {
      res.status(404).json({ message: "Resource not found" });
    } else {
...
async function uploadTrackMap(req: Request, res: Response) {
  try {
    ...
    await em.flush();
    res.status(200).json({ message: "Track map uploaded successfully", data: addImageUrls(req, circuito) });
  } catch (error: any) {
    if (error instanceof NotFoundError) {
      res.status(404).json({ message: "Resource not found" });
    } else {
...
async function deleteTrackMap(req: Request, res: Response) {
  try {
    ...
    res.status(200).json({ message: "Track map deleted successfully", data: addImageUrls(req, circuito) });
  } catch (error: any) {
    if (error instanceof NotFoundError) {
      res.status(404).json({ message: "Resource not found" });
    } else {
...
async function uploadPhotoImage(req: Request, res: Response) {
  try {
    ...
    await em.flush();
    res.status(200).json({ message: "Photo image uploaded successfully", data: addImageUrls(req, circuito) });
  } catch (error: any) {
    if (error instanceof NotFoundError) {
      res.status(404).json({ message: "Resource not found" });
    } else {
...
async function deletePhotoImage(req: Request, res: Response) {
  try {
    ...
    res.status(200).json({ message: "Photo image deleted successfully", data: addImageUrls(req, circuito) });
  } catch (error: any) {
    if (error instanceof NotFoundError) {
      res.status(404).json({ message: "Resource not found" });
    } else {
...
export { findAll, findOne, add, update, remove, sanitizeCircuitoInput, uploadTrackMap, deleteTrackMap, uploadPhotoImage, deletePhotoImage };
